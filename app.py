...
st.set_page_config("Data Entry Form", layout="wide")

df = pd.read_excel("data/Fruits.xlsx", engine="openpyxl")
# --------------- SIDE BAR ----------------
...
if side_bar == "Data Entry Form":
    ...
    df2 = pd.read_excel("data/Fruits.xlsx", engine="openpyxl")
...
if side_bar == "Data Filter/Update":
    ...
    if st.button("Update"):
        ...
        y.to_excel("data/test.xlsx", index=True)
